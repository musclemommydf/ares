# Auto-generated from EN 302 307-1 Annex B/C (DVB-S2 LDPC parity-bit accumulator
# addresses), cross-checked against the ETSI PDF + gr-dtv. One row per 360-bit
# info group; q = (nldpc - kldpc)/360. addresses 0..(nldpc-kldpc-1). DO NOT EDIT.

NLDPC = {'normal': 64800, 'short': 16200}

# ── normal FECFRAME (nldpc = 64800) ──
LDPC_NORMAL = {
    '1/4': (
        16200, 135,   # kldpc, q
        [
